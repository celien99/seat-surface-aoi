...
def test_recipe_ignores_patchcore_model_score_threshold() -> None:
    recipe = recipe_from_dict(
        {
            "recipe_id": "patchcore_score_threshold_ignored",
            "sku": "sku",
            "light_order": ["DIFFUSE", "POLAR_DIFFUSE", "HIGH_LEFT"],
    ...
    assert recipe.models["patchcore"].score_threshold == 0.0
